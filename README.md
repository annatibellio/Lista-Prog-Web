...
- **Conversão de número com vírgula ou ponto:** os campos numéricos usam `input type="number"`, que já lida com isso na maioria dos navegadores, mas o PHP também trata os dois formatos (`1.57` e `1,57`) antes de calcular, pra não depender só do comportamento do navegador.
